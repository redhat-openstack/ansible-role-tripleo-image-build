...
def tripleo_build_images(config_files, output_directory, skip):
    ...
    try:
        ...
        # We have to fix that in tripleo-common... I tried various means to
        # use mock as a hack, but no luck. The patch to tripleo-common is pretty
        # straight-forward though.
        # just need to patch in a log file to the subprocess.check_call() here:
