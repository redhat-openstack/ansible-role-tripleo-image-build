...
artib_dib_prepare_script          | Jinja2 template bash script used to prepare $virthost for building images with DIB
...
artib_dib_release_rpm             | where DIB itself comes from on $virthost.  Default: "http://rdoproject.org/repos/openstack-liberty/rdo-release-liberty.rpm"
